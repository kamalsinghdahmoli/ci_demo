<hr />
<?php echo form_open(base_url() . 'parents/attendance_report_selector/'.$student_id); ?>
<div class="row">
...
<?php if ($class_id != '' && $section_id != '' && $month != '' && $sessional_year != '' && $student_id != ''): ?>
  ...
  <?php endif; ?>
    ...
    <?php ?>
            ...
            <center>
                <a href="<?php echo base_url(); ?>parents/attendance_report_print_view/<?php echo $class_id; ?>/<?php echo $section_id; ?>/<?php echo $month; ?>/<?php echo $sessional_year; ?>/<?php echo $student_id; ?>"
