...
<div class="row">
	<div class="col-md-12">
            ...
            <br>
				...
				<?php echo form_open(base_url() . 'accountant/invoice/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
				<div class="row">
					<div class="col-md-6">
				...
				<?php echo form_open(base_url() . 'accountant/invoice/create_mass_invoice' , array('class' => 'form-horizontal form-groups-bordered validate', 'id'=> 'mass' ,'target'=>'_top'));?>
				<br>
				<div class="row">
