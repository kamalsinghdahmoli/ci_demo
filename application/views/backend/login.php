...
<html class="no-js" lang="">
    <head>
      ...
      <meta name="viewport" content="width=device-width, initial-scale=1">
	    ...
	    <link rel="shortcut icon" href="<?php echo base_url();?>assets/login_page/img/favicon.jpg">
    ...
    <body>
		<div class="main-content-wrapper">
			<div class="login-area">
				<div class="login-header">
					<a href="<?php echo base_url();?>login" class="logo">
						<img src="<?php echo base_url();?>assets/login_page/img/logo.jpg" height="60" alt="">
					</a>
            ...
            <a href="<?php echo base_url("login/microsoftLogin"); ?>" type="submit" class="btn form-btn btn-primary btn btn-info btn-block" value="">Microsoft login</a>
					</div>
				</div>
			</div>
