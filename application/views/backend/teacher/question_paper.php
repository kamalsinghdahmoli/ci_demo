<button onclick="showAjaxModal('<?php echo base_url();?>modal/popup/question_paper_add');" 
                ...
                <td>
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                            <li>
                                <a href="#" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/question_paper_edit/<?php echo $row['question_paper_id']; ?>');">
                                    <i class="entypo-pencil"></i>
                                    <?php echo get_phrase('edit');?>
                                </a>
                            </li>
                            <li>
                                <a href="#" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/question_paper_view/<?php echo $row['question_paper_id']; ?>');">
                            ...
                            <li>
                                <a href="#" onclick="confirm_modal('<?php echo base_url();?>teacher/question_paper/delete/<?php echo $row['question_paper_id']; ?>');">
