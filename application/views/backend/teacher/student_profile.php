...
<div class="profile-env">
	<header class="row">
        ...
        <span>
          ...
          ?>
          <a href="<?php echo base_url();?>teacher/student_information/<?php echo $enroll_info->row()->class_id; ?>">
      ...
      <li class="">
        ...
        <?php } ?>
          ...
          <?php echo get_phrase('average_grade_point');?> :
           ...
           <br> <br>
           <a href="<?php echo base_url();?>teacher/student_marksheet_print_view/<?php echo $student_id;?>/<?php echo $row2['exam_id'];?>"
                ...
                <tr>
                  ...
                  <td>
                    <a href="#" class="btn btn-default"
                      onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_view_invoice/<?php echo $payment['invoice_id'];?>')">
