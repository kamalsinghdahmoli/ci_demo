<div class="sidebar-menu">
    ...
    <ul id="main-menu" class="">
        ...
        <li id="search">
  				<form class="" action="<?php echo base_url().''.$account_type.'/student_details' ?>" method="post">
        ...
        <li class="<?php
        if ($page_name == 'rooms' ||
                $page_name == 'create_room' )
            echo 'opened active';
        ?> ">
            <a href="#">
                <i class="entypo-flow-tree"></i>
                <span><?php echo get_phrase('rooms'); ?></span>
            </a>
            <ul>
                
                <li class="<?php if ($page_name == 'create_room') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>rooms/create_room">
                        <span><i class="entypo-dot"></i> <?php echo get_phrase('create_room'); ?></span>
                    </a>
                </li>
        ...
        <li class="<?php if ($page_name == 'manage_attendance' ||
            ...
            <ul>
                    ...
                    <li class="<?php if (($page_name == 'manage_attendance' || $page_name == 'manage_attendance_view')) echo 'active'; ?>">
                        <a href="<?php echo base_url(); ?>admin/manage_attendance">
        ...
        ?> ">
            ...
            <ul>
                ...
                <li class="<?php if ($page_name == 'marks_manage' || $page_name == 'marks_manage_view') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>admin/marks_manage">
                ...
                <li class="<?php if ($page_name == 'question_paper') echo 'active'; ?>">
                    <a href="<?php echo base_url(); ?>admin/question_paper">
