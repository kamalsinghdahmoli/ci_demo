...
<div class="row">
  <div class="col-md-2">
    ...
    <a href="<?php echo base_url();?>admin/frontend_pages/events"
    ...
    <a href="<?php echo base_url();?>admin/frontend_pages/gallery"
    ...
    <a href="<?php echo base_url();?>admin/frontend_pages/about_us"
      class="btn btn-<?php echo $page_content == 'frontend_about_us' ? 'primary' : 'default'; ?> btn-block">
      <?php echo get_phrase('about_us'); ?>
    </a>
    <a href="<?php echo base_url();?>admin/frontend_pages/terms_conditions"
