...
<div class="tab-content">
							...
							<td>
								<div class="btn-group">
									...
									<ul class="dropdown-menu dropdown-default pull-right" role="menu">
										<li>
												<a href="<?php echo base_url();?>admin/frontend_pages/gallery_image/<?php echo $row['frontend_gallery_id'];?>">
										...
										<li class="divider"></li>
											<!-- EDITING LINK -->
											<li>
													<a href="#" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/frontend_gallery_edit/<?php echo $row['frontend_gallery_id'];?>');">
												...
												<!-- DELETION LINK -->
												<!-- <li>
													<a href="#" onclick="confirm_modal('<?php //echo base_url();?>admin/frontend_gallery/delete/<?php //echo $row['frontend_gallery_id'];?>');">
    ...
    <form class="form-horizontal form-groups" method="post"
			action="<?php echo base_url();?>admin/frontend_gallery/add_gallery"
