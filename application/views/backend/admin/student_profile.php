...
<div class="profile-env">
	<header class="row">
        ...
        <span>
          ...
          ?>
          <a href="<?php echo base_url();?>admin/student_information/<?php echo $enroll_info->row()->class_id; ?>">
      ...
      <li class="">
        ...
        <?php } ?>
          ...
          <?php echo get_phrase('average_grade_point');?> :
           ...
           <br> <br>
           <a href="<?php echo base_url();?>admin/student_marksheet_print_view/<?php echo $student_id;?>/<?php echo $row2['exam_id'];?>"
