...
<form class="form-horizontal form-groups" method="post"
  action="<?php echo base_url();?>admin/frontend_gallery/edit_gallery/<?php echo $row['frontend_gallery_id'];?>"
    ...
    <div class="col-sm-7">
      <div class="fileinput fileinput-new" data-provides="fileinput">
        <div class="fileinput-new thumbnail" style="width: 300px; height: 150px;" data-trigger="fileinput">
          <img src="<?php echo base_url(); ?>uploads/frontend/gallery_cover/<?php echo $row['image'];?>" alt="...">
        </div>
