...
<div class="tab-content">
							...
							<td>
								<div class="btn-group">
									...
									<ul class="dropdown-menu dropdown-default pull-right" role="menu">
												<!-- EDITING LINK -->
												<li>
														<a href="<?php echo base_url();?>admin/frontend_pages/news_edit/<?php echo $row['frontend_news_id'];?>">
												...
												<!-- DELETION LINK -->
												<li>
													<a href="#" onclick="confirm_modal('<?php echo base_url();?>admin/frontend_news/delete/<?php echo $row['frontend_news_id'];?>');">
    ...
    <form class="form-horizontal form-groups" id="jq-submit" method="post"
			action="<?php echo base_url();?>admin/frontend_news/add_news"
