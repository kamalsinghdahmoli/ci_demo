...
<div class="tab-content">
							...
							<td>
								<div class="btn-group">
									...
									<ul class="dropdown-menu dropdown-default pull-right" role="menu">
											<!-- EDITING LINK -->
											<li>
													<a href="#" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/frontend_events_edit/<?php echo $row['frontend_events_id'];?>');">
												...
												<!-- DELETION LINK -->
												<li>
													<a href="#" onclick="confirm_modal('<?php echo base_url();?>admin/frontend_events/delete/<?php echo $row['frontend_events_id'];?>');">
    ...
    <form class="form-horizontal form-groups" method="post"
			action="<?php echo base_url();?>admin/frontend_events/add_event"
