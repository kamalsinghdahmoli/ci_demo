<hr />
<a href="javascript:;" onclick="showAjaxModal('<?php echo base_url(); ?>modal/popup/academic_syllabus_add/');"
		...
		<div class="tabs-vertical-env">
			...
			?>
				<li class="<?php if ($row['class_id'] == $class_id) echo 'active';?>">
					<a href="<?php echo base_url();?>admin/academic_syllabus/<?php echo $row['class_id'];?>">
							...
							<tr>
								...
								<td align="center">
									<a class="btn btn-default btn-xs"
										href="<?php echo base_url();?>admin/download_academic_syllabus/<?php echo $row['academic_syllabus_code'];?>">
										<i class="entypo-download"></i>
									</a>
									<a href="#" class="btn btn-danger btn-xs"
										onclick="confirm_modal('<?php echo base_url();?>admin/delete_academic_syllabus/<?php echo $row['academic_syllabus_code'];?>');">
