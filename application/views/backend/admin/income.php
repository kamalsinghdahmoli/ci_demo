...
<div class="row">
	<div class="col-md-12">
			...
			<br>
				...
				<table id="unpaid_tbl" class="table table-bordered datatable example">
                	<thead>
                		<tr>
                			<th>#</th>
				...
				<div class="tab-pane" id="paid">
					...
					<table id="paid_tbl" class="table table-bordered datatable example">
					    <thead>
					        <tr>
					            <th><div>#</div></th>
					            <th><div><?php echo get_phrase('title');?></div></th>
				...
				<div class="tab-pane <?php if($active_tab == 'student_specific_payment_history') echo 'active'; ?>" id="paid_student_specific">
					...
					<br>
					<?php echo form_open(base_url() . 'admin/income/student_specific_payment_history/filter_history');?>
						<div class="row">
