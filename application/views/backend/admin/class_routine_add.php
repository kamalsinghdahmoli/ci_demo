...
<div class="row">
	<div class="col-md-12">
		...
		<?php echo form_open(base_url() . 'admin/class_routine/create' , array('class' => 'form-horizontal form-groups validate','target'=>'_top'));?>
          ...
          <!--   <div class="form-group">
            ...
            <div class="form-group">
                <label class="col-sm-3 control-label"><!-- <?php //echo get_phrase('starting_time');?> -->Starting Date</label>
                <div class="col-sm-9">
                <input id="starting_date" name="starting_date" class="form-control" type="text">
            ...
            <div class="form-group">
                <label class="col-sm-3 control-label"><!-- <?php //echo get_phrase('ending_time');?> -->Ending Date</label>
                <div class="col-sm-9">
                    <input id="ending_date" name="ending_date" class="form-control" type="text">
                   <!--  <div class="col-md-3">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <select name="room_id" id = "room_id" class="form-control selectboxit" style="width:100%;">
                        <option value=""><?php echo get_phrase('room_name');?></option>
                        <?php 
