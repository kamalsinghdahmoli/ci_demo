...
<?php echo form_open(base_url() . 'admin/attendance_report_selector'); ?>
<div class="row">
...
<center>
<a href="<?php echo base_url(); ?>admin/attendance_report_print_view/<?php echo $class_id; ?>/<?php echo $section_id; ?>/<?php echo $month; ?>/<?php echo $sessional_year; ?>"
...
<script type="text/javascript">
    ...
    function select_section(class_id) {
        ...
        $.ajax({
            url: '<?php echo base_url(); ?>admin/get_section/' + class_id,
