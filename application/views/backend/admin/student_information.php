    ...
    <div class="col-md-12">
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="home">
                ...
                <table class="table table-bordered datatable" id="table_students">
                    <thead>
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                        ...
                                        <li>
                                            <a href="<?php echo base_url();?>admin/student_profile/<?php echo $row['student_id'];?>">
                                        ...
                                        <li>
                                            <a href="#" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/student_id/<?php echo $row['student_id'];?>');">
                                        ...
                                        <li class="divider"></li>
                                        <li>
                                          <a href="#" onclick="confirm_modal('<?php echo base_url();?>admin/delete_student/<?php echo $row['student_id'];?>/<?php echo $class_id;?>');">
...
<script type="text/javascript">
	...
	jQuery(document).ready(function($)
	{
		...
		var datatable = $("#table_students").dataTable({
