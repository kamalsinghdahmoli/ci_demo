...
<div class="row">
  <form class="form-horizontal form-groups" method="post" enctype="multipart/form-data"
    action="<?php echo base_url();?>admin/frontend_gallery/upload_images/<?php echo $gallery_id;?>">
  ...
  ?>
    <div class="col-md-3" style="margin-top: 25px;">
      ...
      <a href="#" class="btn btn-danger"
        onclick="confirm_modal('<?php echo base_url();?>admin/frontend_gallery/delete_image/<?php echo $row['frontend_gallery_image_id'];?>/<?php echo $row['frontend_gallery_id'];?>');">
