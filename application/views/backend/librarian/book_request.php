                    ...
                    <?php if($row['status'] == 0) { ?>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                <li>
                                    <a href="<?php echo base_url();?>librarian/book_request/accept/<?php echo $row['book_request_id'];?>">
                                        <i class="entypo-check"></i>
                                        <?php echo get_phrase('accept');?>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url();?>librarian/book_request/reject/<?php echo $row['book_request_id'];?>">
