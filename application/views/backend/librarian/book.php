        ...
        <br>
                        ...
                        <tr>
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                    ...
                                    <li>
                                        <a href="#" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/book_edit/<?php echo $row['book_id'];?>');">
                                    ...
                                    <li>
                                        <a href="#" onclick="confirm_modal('<?php echo base_url();?>librarian/book/delete/<?php echo $row['book_id'];?>');">
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                    ...
                    <?php echo form_open(base_url() . 'librarian/book/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top','enctype'=>'multipart/form-data'));?>
