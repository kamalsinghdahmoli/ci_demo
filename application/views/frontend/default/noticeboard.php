        ...
        <div class="row">
          <?php foreach ($notices as $row) { ?>
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="card kmmc-grid-news">
                    <img class="card-img-top img-fluid" alt="" src="<?php echo base_url(); ?>uploads/frontend/noticeboard/<?php echo $row['image'];?>">
                    <div class="card-body">
                        <h3 class="card-title"><a href="<?php echo base_url();?>home/notice_details/<?php echo $row['notice_id'];?>"><?php echo $row['notice_title']; ?></a></h3>
                        <p class="card-text">
                        ...
                        <a href="<?php echo base_url();?>home/notice_details/<?php echo $row['notice_id'];?>" class="pull-right btn">
